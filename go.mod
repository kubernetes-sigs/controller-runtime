...
require k8s.io/webhook-auth v0.0.0-00010101000000-000000000000
...
replace k8s.io/webhook-auth => /Users/benjaminpetersen/github.com/benjaminapetersen_forks/kubernetes/staging/src/k8s.io/webhook-auth
