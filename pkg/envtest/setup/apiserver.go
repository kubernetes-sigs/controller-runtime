...
type APIServer struct {
	...
	// CAData contains the CA certificate to use to connect to this API server.
	// It will only be set if the certificates are autogenerated (i.e. existing
	// apiserver.crt does exist in CertDir).
	CAData []byte
...
func (s *APIServer) setProcessState() error {
	...
	if err := s.populateCertsIfNeeded(); err != nil {
		return err
	}
...
func (s *APIServer) populateCertsIfNeeded() error {
