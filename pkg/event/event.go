...
type CreateEvent[T client.ObjectConstraint] struct {
...
// by a source.Source and transformed into a reconcile.Request by an handler.EventHandler.
type UpdateEvent[T client.ObjectConstraint] struct {
...
// by a source.Source and transformed into a reconcile.Request by an handler.EventHandler.
type DeleteEvent[T client.ObjectConstraint] struct {
	// Object is the object from the event
	Object T
...
type GenericEvent[T client.ObjectConstraint] struct {
	// Object is the object from the event
	Object T
}
