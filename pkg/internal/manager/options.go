...
// ApplyToManager will set options on the other Options struct.
func (o Options) ApplyToManager(other *Options) error {
	other.Namespace = o.Namespace
	other.SyncPeriod = o.SyncPeriod
	other.MetricsBindAddress = o.MetricsBindAddress
	other.HealthProbeBindAddress = o.HealthProbeBindAddress
	other.ReadinessEndpointName = o.ReadinessEndpointName
	other.LivenessEndpointName = o.LivenessEndpointName
	other.Port = o.Port
	other.Host = o.Host
	other.CertDir = o.CertDir
	other.TLSOpts = o.TLSOpts
	other.WebhookServer = o.WebhookServer
	other.NewCache = o.NewCache
	other.NewClient = o.NewClient
	other.BaseContext = o.BaseContext
	other.ClientDisableCacheFor = o.ClientDisableCacheFor
	other.DryRunClient = o.DryRunClient
	other.EventBroadcaster = o.EventBroadcaster
	other.GracefulShutdownTimeout = o.GracefulShutdownTimeout
	other.Controller = o.Controller
	other.MakeBroadcaster = o.MakeBroadcaster
	other.NewRecorderProvider = o.NewRecorderProvider
	other.NewResourceLock = o.NewResourceLock
	other.NewMetricsListener = o.NewMetricsListener
	other.NewHealthProbeListener = o.NewHealthProbeListener
	return nil
}
...
func (o *Options) AndFrom(loader config.ControllerManagerConfiguration) error {
	newObj, err := loader.Complete()
	if err != nil {
		return err
	}

	// Handle leader election options.
	o.setLeaderElectionConfig(newObj)
...
func (o *Options) AndFromOrDie(loader config.ControllerManagerConfiguration) {
	if err := o.AndFrom(loader); err != nil {
		panic(fmt.Sprintf("could not parse config file: %v", err))
	}
}

func (o *Options) setLeaderElectionConfig(obj v1alpha1.ControllerManagerConfigurationSpec) {
...
// Defaults set default values for Options fields.
func (o *Options) Defaults() {
	// Allow newResourceLock to be mocked
	if o.NewResourceLock == nil {
		o.NewResourceLock = leaderelection.NewResourceLock
	}

	// Allow newRecorderProvider to be mocked
	if o.NewRecorderProvider == nil {
		o.NewRecorderProvider = intrec.NewProvider
	}
	...
	if o.EventBroadcaster == nil {
		...
		o.MakeBroadcaster = func() (record.EventBroadcaster, bool) {
			return record.NewBroadcaster(), true
		}
	} else {
		o.MakeBroadcaster = func() (record.EventBroadcaster, bool) {
			return o.EventBroadcaster, false
		}
	}

	if o.NewMetricsListener == nil {
		o.NewMetricsListener = metrics.NewListener
	}
	...
	if o.ReadinessEndpointName == "" {
		o.ReadinessEndpointName = DefaultReadinessEndpoint
	}

	if o.LivenessEndpointName == "" {
		o.LivenessEndpointName = DefaultLivenessEndpoint
	}

	if o.NewHealthProbeListener == nil {
		o.NewHealthProbeListener = DefaultHealthProbeListener
	}

	if o.GracefulShutdownTimeout == nil {
		gracefulShutdownTimeout := DefaultGracefulShutdownPeriod
		o.GracefulShutdownTimeout = &gracefulShutdownTimeout
	}
	...
	if o.BaseContext == nil {
		o.BaseContext = DefaultBaseContext
	}
}
