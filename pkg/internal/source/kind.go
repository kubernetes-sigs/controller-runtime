...
type Kind[T client.ObjectConstraint] struct {
...
func (ks *Kind[T]) Start(ctx context.Context, handler handler.EventHandler[T], queue workqueue.RateLimitingInterface,
