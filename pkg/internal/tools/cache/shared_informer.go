...
func NewSharedIndexInformerWithOptions(lw cache.ListerWatcher, exampleObject runtime.Object, options SharedIndexInformerOptions) cache.SharedIndexInformer {
	...
	return &sharedIndexInformer{
		indexer:                         cache.NewIndexer(options.KeyFunc, options.Indexers),
